...
IF(NOT DEFINED RABBITIM_THIRD_PACKAGE_DIR)
    SET(RABBITIM_THIRD_PACKAGE_DIR ${CMAKE_SOURCE_DIR}/ThirdLibrary/${TOOLCHAIN_NAME}${RABBIT_TOOLCHAIN_VERSION}_${RABBITIM_ARCHITECTURE}_qt${Qt5_VERSION}_${RABBIT_CONFIG}) #第三方开发包目录
ENDIF()
IF(NOT BUILD_SHARED_LIBS AND EXISTS "${RABBITIM_THIRD_PACKAGE_DIR}_static")
