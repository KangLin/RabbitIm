...
class CAndroidNotification : public QObject
{
    Q_OBJECT
    //Q_PROPERTY(QString notification READ notification WRITE setNotification NOTIFY notificationChanged)
public:
    explicit CAndroidNotification(QObject *parent = 0);
    virtual ~CAndroidNotification();

    void setNotification(const QString &szMessage, const QString &szTitle = QString());
