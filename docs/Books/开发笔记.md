...
* [Building Qt 5 from Git](http://wiki.qt.io/Building-Qt-5-from-Git)[中文](http://wiki.qt.io/Building-Qt-5-from-Git-SimplifiedChinese)

* [Building Qt 5 for Android](http://wiki.qt.io/Qt5ForAndroidBuilding)

* [MinGW 64 bit](http://wiki.qt.io/MinGW-64-bit)

* [Qt贡献向导](http://wiki.qt.io/Qt-Contribution-Guidelines)
...
* [CMake:CPackPackageGenerators](http://www.cmake.org/Wiki/CMake:CPackPackageGenerators#DEB_.28UNIX_only.29)

* [Debian 新维护人员手册](http://www.debian.org/doc/manuals/maint-guide/index.zh-cn.html)

* [debian 打包](http://wiki.ubuntu.com.cn/Deb包管理向导#dh-make)

* [debhelper 7](http://wzssyqa.blog.163.com/blog/static/5886261220103211459421/)

* [从源码构建二进制deb包的步骤（cmake install 命令和devhelper dh_make的使用）](http://gmd20.blog.163.com/blog/static/1684392320131129484512/)
