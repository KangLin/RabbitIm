...
#export ANDROID_SDK=/D/software/android-sdk-windows     #指定 android sdk 根目录,在msys2下需要注意路径符号："/"  
...
#QT_ROOT=/c/Qt/Qt5.4.2/5.4/android_armv7 #/home/l/Qt5.5.0/5.5/android_armv7        #QT 安装根目录,默认为:${RabbitImRoot}/ThirdLibrary/android/qt  
...
RABBITIM_BUILD_PLATFORMS_VERSION=15    #android ndk api (平台)版本号,默认 9   
