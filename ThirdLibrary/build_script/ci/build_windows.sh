...
#./build_qrencode.sh ${TARGET} ${SOURCE_DIR}/ThirdLibrary/src/libqrencode > /dev/null
./build_x264.sh ${TARGET} ${SOURCE_DIR}/ThirdLibrary/src/x264 > /dev/null
...
./build_ffmpeg.sh ${TARGET} ${SOURCE_DIR}/ThirdLibrary/src/ffmpeg 
./build_qxmpp.sh ${TARGET} ${SOURCE_DIR}/ThirdLibrary/src/qxmpp 
./build_qzxing.sh ${TARGET} ${SOURCE_DIR}/ThirdLibrary/src/qzxing
